...
const Alert = () => {
  ...
  return (
    <div
      className={`fixed left-1/2 top-14 z-30 w-[90%] max-w-md -translate-x-1/2 animate-slideDown rounded-lg px-6 py-4 text-center text-white shadow-lg transition-all duration-500 ${alertColor}`}
    >
